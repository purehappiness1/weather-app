...
const Day4 = () => {
  ...
  const t = Math.round(x.daily[3].temp.min - 273.15) 
  const t2 = Math.round(x.daily[3].temp.max - 273.15) 
  setValue(x.daily[3].weather[0].main); 
  if (x.daily[3].weather[0].main === 'Rain') {
    setPic('rainy.png')
  }
  if (x.daily[3].weather[0].main === 'Clouds') {
    setPic('clouds.png')
  }
  if (x.daily[3].weather[0].main === 'clear') {
    setPic('sunny.png')
  }
